...
public class Exercise {
   ...
   */
  protected static void resetIDNumbers() {
    Exercise.nextIDNumber = 1;
  }

  /**
   * Creates a new Exercise and initializes its instance fields type, description, and its unique ID
   * number
   * 
   * @param type        the category of exercise to create. It can be any of the constant
   *                    WorkoutTypes defined in the enum WorkoutType: WorkoutType.WARMUP,
   *                    WorkoutType.PRIMARY, or WorkoutType.COOLDOWN
